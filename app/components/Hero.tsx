...
const Hero = () => {
    return (
        <>
            <div className="container mt-4 pt-4 md:mt-10 md:pt-10 relative hidden lg:block" id='hero'>
            ...
            <div className="container mt-4 pt-4 md:mt-10 md:pt-10 relative lg:hidden" id='hero'>
